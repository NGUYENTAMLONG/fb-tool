...
@Entity("fb_group_keyword", { schema: "crawler" })
export class FbGroupKeyword {
  ...
  @Column("varchar", { name: "privacy", nullable: true, length: 255 })
  privacy: string | null;
  ...
  @Column("int", { name: "status_member", default: () => "'0'" })
  statusMember: number;

  @Column("int", { name: "back_day", default: () => "'0'" })
  backDay: number;
}
